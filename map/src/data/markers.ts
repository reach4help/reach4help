/* eslint max-len: 0 */
import * as markers from '@reach4help/model/lib/markers';
import firebase from 'firebase/app';

export type Location = markers.Location<firebase.firestore.GeoPoint>;

export type MarkerInfo = markers.MarkerInfo<firebase.firestore.GeoPoint>;
...
const OLD_MARKERS: markers.OldMarkerInfo[] = [
  {
