/*
we need an HTTP cloud function that :
accepts latitude and longitude as body parameters of the request
perform a geospatial query that would return a list of volunteers within 5 mile radius of the provided latitude and longitude
return the latitude and longitude of each volunteer within this radius along with their address object.
6:15
you can obtain the latitude, longitude and address for each volunteer from their privilegedInformation sub-collection in the users collection
6:16
*/
